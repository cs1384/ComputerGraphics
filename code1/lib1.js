...
/*  
Tin: Why don't we put set function into Constructor? Because that way each 
instance will have that function in the memory. Using prototype will only have 
one copy of the function in the memory 
*/
Vector3.prototype = {
   set : function(x,y,z) {
      this.x = x;
...
function gl_init(gl, vertexShader, fragmentShader) {
   ...
   //gl.vertexAttribPointer(gl.aPosition, 2, gl.FLOAT, true, 0, 0);
